(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/regenerator'), require('react'), require('jmuxer'), require('react-modal'), require('socket.io-client')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/regenerator', 'react', 'jmuxer', 'react-modal', 'socket.io-client'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["react-js-carplay"] = {}, global._asyncToGenerator, global._slicedToArray, global._regeneratorRuntime, global.React, global.JMuxer, global.Modal, global.io));
})(this, (function (exports, _asyncToGenerator, _slicedToArray, _regeneratorRuntime, React, JMuxer, Modal, io) { 'use strict';
  ...
  function Carplay(_ref) {
    ...
    React.useEffect(function () {
      ...
      jmuxer = new JMuxer__default["default"]({
        node: 'player',
        mode: 'video',
        maxDelay: 30,
        fps: settings.fps,
    ...
    var handleDown = function handleDown(e) {
      var currentTargetRect = e.target.getBoundingClientRect();
      var x = e.touches[0].clientX - currentTargetRect.left;
  ...
  PCMPlayer.prototype.updateSample = function (_ref) {
    var sampleRate = _ref.sampleRate,
      channels = _ref.channels;
    console.log("updating Sample rate: ", sampleRate, channels);
    this.option.sampleRate = sampleRate;
    this.option.channels = channels;
  };
  ...
  function CarplayAudio () {
    ...
    var feed2 = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(data) {
  ...
  exports.Carplay = Carplay;
  exports.CarplayAudio = CarplayAudio;
